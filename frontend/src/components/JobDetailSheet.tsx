  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className="dialog-overlay job-sheet-overlay" />
        <DialogPrimitive.Content className="job-sheet">
          ...
          {/* Keyed by job id so a new posting remounts the body scrolled to the top. */}
          <div key={job?.id ?? "empty"} className="job-sheet-body">
